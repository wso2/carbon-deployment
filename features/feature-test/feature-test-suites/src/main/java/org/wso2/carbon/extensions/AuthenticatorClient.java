...
/**
 * Provides utility methods for authenticate user login and logout
 */
public class AuthenticatorClient {
     ...
     * @return - returns sessionCookie after login
     ...
     * @throws RemoteException - Throws if error occurred while logout.
     */
