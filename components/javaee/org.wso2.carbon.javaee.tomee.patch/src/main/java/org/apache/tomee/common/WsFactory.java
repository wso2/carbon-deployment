...
/**
 * This class was copied from TomEE-1.7.2 tag in https://github.com/apache/tomee
 * Reason - While doing TomEE-1.7.2 upgrade found an existing issue in TomEE https://issues.apache.org/jira/browse/TOMEE-1590
 * Since that has been fixed with TomEE 7.x we have to patch this for 1.7.2 ThusithaD
 */
