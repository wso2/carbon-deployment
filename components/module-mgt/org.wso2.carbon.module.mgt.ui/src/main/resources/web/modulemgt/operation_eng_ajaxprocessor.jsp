...
<%@ page
    import="org.wso2.carbon.module.mgt.ui.util.ModuleManagementConstants"%>
...
<%
            ...
            try {
                ...
                if (ModuleManagementConstants.ENGAGE.equals(action)) {
                    client.engageModuleForOperation(moduleId,serviceName,operationName);
                    msg = resourceBundle.getString("success.engage");
                } else if (ModuleManagementConstants.DISENGAGE.equals(action)) {
                    client.disengageModuleForOperation(moduleId,serviceName,operationName);
