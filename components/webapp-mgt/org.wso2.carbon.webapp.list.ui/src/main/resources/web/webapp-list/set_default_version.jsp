...
<%
//    String webappFileName = request.getParameter("currentFileName");
//    String currentVersion = request.getParameter("currentVersion");
//    String newFileName = request.getParameter("newFileName");
//    String newVersion = request.getParameter("newVersion");

    String appGroupName = request.getParameter("appGroupName");
    String appFileName = request.getParameter("appFileName");
...
%>
<script>
    location.href = '<%= redirectPage %>?pageNumber=<%=pageNumberInt%>'
