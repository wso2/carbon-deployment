            ...
            try {
                ...
                if (webappState.equalsIgnoreCase("all")) {
                    ...
                    if (webappType.equalsIgnoreCase("JaxWebapp")) {
                        webAppDataExtractor.getServletXML(
                                client.getWarFileInputStream(webapp.getWebappFile(), hostName, webappType));
                        ...
                        <table class="styledLeft" id="webappTable" style="margin-left: 0px;"
                            ...
                            <tr>
                                ...
                                <td><%= new SimpleDateFormat("yyyy-MM-dd' 'HH:mm:ss")
                                        .format(new Date(webapp.getLastModifiedTime()))%>
                                </td>
                            </tr>
                        </table>
                        <br>
                    ...
                    */
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <% String cek = "";
                                        ...
                                        boolean checked = false;
                                        String webAppName = webappFileName;
                                        WebappAdminClient adminClient = new WebappAdminClient(cookie, backendServerURL,
                                    ...
                                    <div id="bam_statistic_enabled" <%= enable %> >
                                        <fmt:message key="bam.statistic.monitoring.enable"/> [<a
                                            id="bam_statistcs_enable_url" type=""><font
                                            style="color:red;">Deactivate</font></a>]
                                    </div>
                                    <div id="bam_statistic_disabled" <%= disable %> >
                                        <fmt:message key="bam.statistic.monitoring.disable"/> [<a
                                            id="bam_statistcs_disable_url" type=""><font
                                            style="color:green;">Activate</font></a>]
                                    </div>
                    ...
                    <td width="50%">
                        <table class="styledLeft" id="wsClientTable"
                            ...
                            <tr>
                                <td colspan="2" align="left">
                                    ...
                                    <%
                                        ...
                                        String serviceName = wsdlURL
                                                .substring(wsdlURL.indexOf(servletContext), wsdlURL.indexOf("?wsdl"));
                                    %>
                            ...
                            <tr>
                                <td>
                                    <a href="#" onclick="validateAndSubmitTryit('<%=wsdlURLS.get(i)%>')"
                                       class="icon-link"
                            ...
                            <tr>
                                <td>
                                    <a href="../wsdl2code/index.jsp?generateClient=<%=wsdlURLS.get(i)%>&toppage=false&resultType=cxf&api=jaxws"
                                       class="icon-link"
                    ...
                    <td width="50%">
                        <table class="styledLeft" id="rsClientTable"
                            ...
                            <tr>
                                <td colspan="2" align="left">
                                    ...
                                    <%
                                        ...
                                        String JAXRSServiceName = wadlURL
                                                .substring(wadlURL.indexOf(servletContext), wadlURL.indexOf("?_wadl"));
                                    %>
                            ...
                            <tr>
                                <td>
                                    <a href="../wsdl2code/index.jsp?generateClient=<%=wadlURLS.get(i)%>&toppage=false&resultType=cxf&api=jaxrs"
                                       class="icon-link"
                                       style='background-image:url(images/genclient.gif)'>
                            ...
                            <tr>
                                ...
                                %>
                                    <a href="<%=defaultPrefix%>/services?wadltryit&resourceurl=<%=URLEncoder.encode(wadlURLS.get(i).toString().replace("?_wadl", ""), "UTF-8")%>"
                                       class="icon-link" style="background-image:url(images/tryit.gif);"
