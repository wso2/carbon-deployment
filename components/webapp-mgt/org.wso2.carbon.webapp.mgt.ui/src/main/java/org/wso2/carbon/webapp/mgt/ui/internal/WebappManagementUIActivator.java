 ...
 */
package org.wso2.carbon.webapp.mgt.ui.internal;
 ...
 */
public class WebappManagementUIActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(WebappManagementUIActivator.class);
