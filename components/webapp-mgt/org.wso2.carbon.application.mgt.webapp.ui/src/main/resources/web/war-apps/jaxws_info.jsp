...
<fmt:bundle basename="org.wso2.carbon.application.mgt.webapp.ui.i18n.Resources">
    ...
    <table class="styledLeft" id="webappTable" width="60%">
        <thead>
        <tr>
            <th width="35%"><img src="../webapp-mgt/images/jax_type.gif" alt=""
                                 style="vertical-align:middle;">&nbsp;<fmt:message
                    key="carbonapps.webapp.jax.web.application"/></th>
        ...
        <tr>
            ...
            <td>
                ...
                &webappType=jaxWebapp&defaultHostName=<%=data.getHostName()%>"><%= data.getContext()%>
                </a></td>
            <% } %>
            <td><%= data.getState()%>
            </td>
