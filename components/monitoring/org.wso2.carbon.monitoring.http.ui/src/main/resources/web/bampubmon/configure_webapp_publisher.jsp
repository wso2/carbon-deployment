...
<%@ page import="org.wso2.carbon.monitoring.http.stub.conf.ServiceEventingConfigData" %>
<%@ page import="org.wso2.carbon.monitoring.http.stub.conf.Property" %>
<%@ page import="org.wso2.carbon.monitoring.http.ui.MonitoringAdminClient" %>
...
%><fmt:bundle basename="org.wso2.carbon.monitoring.http.ui.i18n.Resources">

<carbon:breadcrumb
        label="bam.statistics"
        resourceBundle="org.wso2.carbon.monitorng.http.ui.i18n.Resources"
        topPage="true"
        request="<%=request%>"/>
<%
    String setConfig = request.getParameter("setConfig"); // hidden parameter to check if the form is being submitted
    String enableMonitoring = request.getParameter("enableMonitoring"); // String value is "on" of checkbox clicked, else null
...
//    String activityDescription = request.getParameter("activity_description");
    ...
    MonitoringAdminClient client = new MonitoringAdminClient(
    ...
    if (setConfig != null) {    // form submitted request to set eventing config
        ...
        if (enableMonitoring != null) {
            eventingConfigData.setMonitoringEnabled(true);
        } else {
...
<%
    ...
    boolean isWebappStatsEnable = eventingConfigData.getMonitoringEnabled();
...
<script id="source" type="text/javascript">
    ...
    /*function enableStatisticsStreamFields() {
        if (document.getElementsByName()[0]('enableMonitoring').checked) {
...
<div id="middle">
    <h2>
        <fmt:message key="monitoring.publisher.config"/>
    </h2>
    ...
    <div id="workArea">
        ...
        <% if (eventingConfigData != null && !eventingConfigData.getPublishingEnabled()) { %>
            <div class="alert-error">
                Monitoring data publishing currently disabled. To enable it configure MonitoringDataPublishing to
            ...
            <table width="100%" class="styledLeft" style="margin-left: 0px;">
                ...
                <tr>
                    <td>
                        ...
                        <input type="checkbox" name="enableMonitoring"
                               checked="true"  class="serviceConfigurationCheckBox" onchange="enableStatisticsStreamFields()">&nbsp;&nbsp;&nbsp;&nbsp;
                        <% } else { %>
                        <input type="checkbox" name="enableMonitoring" class="serviceConfigurationCheckBox" onchange="enableStatisticsStreamFields()">&nbsp;&nbsp;&nbsp;&nbsp;
                        <% } %>
                        <fmt:message key="enable.monitoring"/>
