...
public class InternalEventingConfigData {
    ...
    private String streamName = WebappMonitoringPublisherConstants.STREAM_NAME;
    private String version = WebappMonitoringPublisherConstants.VERSION;
    private String nickName = WebappMonitoringPublisherConstants.NICK_NAME;
    private String description = WebappMonitoringPublisherConstants.DISCRIPTION;
    ...
    public void setMonitoringEnabled(boolean webappStatsEnabled) {
