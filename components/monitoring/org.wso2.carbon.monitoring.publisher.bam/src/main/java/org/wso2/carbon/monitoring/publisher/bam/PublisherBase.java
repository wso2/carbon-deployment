...
import org.wso2.carbon.monitoring.publisher.bam.config.StreamConfigContext;
import org.wso2.carbon.monitoring.publisher.bam.config.StreamConfigurationReader;
...
public abstract class PublisherBase {
    ...
    public PublisherBase() throws BAMPublisherConfigurationException {
        configContext = StreamConfigurationReader.getInstance().getStreamConfiguration(getDataStreamName());
