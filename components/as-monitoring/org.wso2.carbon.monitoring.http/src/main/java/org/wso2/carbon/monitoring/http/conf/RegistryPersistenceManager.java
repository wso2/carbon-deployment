...
*/
package org.wso2.carbon.monitoring.http.conf;
...
import org.wso2.carbon.monitoring.http.util.BAMDataPublisherConstants;
...
public class RegistryPersistenceManager {
    ...
    public ServiceEventingConfigData load() {
        ...
        eventingConfigData.setMonitoringEnabled(false);
        ...
        try {
            String serviceStatsStatus = getConfigurationProperty(
                    WebappMonitoringPublisherConstants.WEBAPP_MONITORING_REG_PATH,
                    WebappMonitoringPublisherConstants.ENABLE_WEBAPP_MONITORING);

            String bamUrl = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.BAM_URL);
            String bamUserName = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.BAM_USER_NAME);
            String bamPassword = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.BAM_PASSWORD);

            String streamName = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.STREAM_NAME);
            String version = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.VERSION);
            String description = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.DESCRIPTION);
            String nickName = getConfigurationProperty(WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH,
                    BAMDataPublisherConstants.NICK_NAME);

            Properties properties = getAllConfigProperties(WebappMonitoringPublisherConstants.WEBAPP_PROPERTIES_REG_PATH);

            if (serviceStatsStatus != null && bamUrl != null && bamUserName != null && bamPassword != null) {

                eventingConfigData.setMonitoringEnabled(Boolean.parseBoolean(serviceStatsStatus));
    ...
    public InternalEventingConfigData fillEventingConfigData(ServiceEventingConfigData eventingConfigData) {
        ...
        eventConfigNStreamDef.setMonitoringEnabled(eventingConfigData.isMonitoringEnabled());
    ...
    public void update(ServiceEventingConfigData eventingConfigData) throws RegistryException {
        ...
        updateConfigurationProperty(WebappMonitoringPublisherConstants.ENABLE_WEBAPP_MONITORING,
                eventingConfigData.isMonitoringEnabled(),
                WebappMonitoringPublisherConstants.WEBAPP_MONITORING_REG_PATH);
        updateConfigurationProperty(BAMDataPublisherConstants.BAM_URL, eventingConfigData.getUrl(),
                WebappMonitoringPublisherConstants.WEBAPP_COMMON_REG_PATH);
        ...
        if (propertiesDTO != null) {
            ...
            updateAllProperties(properties, WebappMonitoringPublisherConstants.WEBAPP_PROPERTIES_REG_PATH);
        } else {
            updateAllProperties(null, WebappMonitoringPublisherConstants.WEBAPP_PROPERTIES_REG_PATH);
        }
