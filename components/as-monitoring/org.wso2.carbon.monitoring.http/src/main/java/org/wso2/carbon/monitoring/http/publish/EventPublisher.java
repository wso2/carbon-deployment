...
public class EventPublisher {
    ...
    public void publish(WebappMonitoringEvent webappMonitoringEvent, InternalEventingConfigData configData) {
        List<Object> correlationData = webappMonitoringEvent.getCorrelationData();
        List<Object> metaData = webappMonitoringEvent.getMetaData();
        List<Object> payLoadData = webappMonitoringEvent.getEventData();
	    ...
	    StreamDefinition streamDef = configData.getStreamDefinition();
