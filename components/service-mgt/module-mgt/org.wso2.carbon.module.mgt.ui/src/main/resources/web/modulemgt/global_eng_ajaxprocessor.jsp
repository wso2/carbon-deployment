...
<%
    ...
    try {
        ...
        if (ModuleManagementConstants.ENGAGE.equals(action)) {
            client.globallyEngageModule(moduleId);
            msg = resourceBundle.getString("success.global.engage");
        } else if (ModuleManagementConstants.DISENGAGE.equals(action)) {
            client.globallyDisengageModule(moduleId);
            msg = resourceBundle.getString("success.global.disengage");
        }
        ...
        ModuleManagementUtils.handleModuleMgtErrors(e,request,response,null);
        return;
    }
%>